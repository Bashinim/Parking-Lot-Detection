 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "    parser.add_argument(\n",
    "        \"labelme_images\",\n",
    "        help=\"B:/Masters/Thesis/Datasets/Cowc for detectrone2 test/train\",\n",
    "        type=str,\n",
    "    )\n",
    "    parser.add_argument(\n",
    "        \"--output\", help=\"B:/Masters/Thesis/Datasets/Cowc for detectrone2 test/Train_annotations.json\", default=\"trainval.json\"\n",
    "    )\n",
